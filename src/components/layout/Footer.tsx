        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex gap-4">
              ...
              <a href="https://wa.me/22602029494" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center hover:bg-green-500 transition-all duration-300 group">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-white/70 leading-relaxed">
              Albarka Trade International est votre partenaire de confiance pour la commercialisation 
              de produits vivriers de qualité : riz, sucre, huiles alimentaires, jus et autres prestations.
            </p>
            <p className="text-sm text-white/70 leading-relaxed">
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/70">Ouagadougou, Burkina Faso</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-10 h-10 rounded-lg bg-primary/20 flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  ...
                  <a href="tel:+22602029494" className="text-sm text-white/70 hover:text-primary transition-colors">
                    +226 02 02 94 94
                  </a>
                </div>
              </li>
